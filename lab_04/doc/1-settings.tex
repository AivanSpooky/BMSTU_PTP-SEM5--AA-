...
\usepackage{etoolbox} % Пакет для патчинга команд

% Патчим \chapter, чтобы он не начинался с новой страницы
\makeatletter
\patchcmd{\chapter}{\clearpage}{}{}{}
\makeatother

% Настройка формата заголовков глав и секций
\titleformat{\chapter}{\LARGE\bfseries}{\thechapter}{20pt}{\LARGE\bfseries}
\titleformat{\section}{\Large\bfseries}{\thesection}{20pt}{\Large\bfseries}

\titlespacing*{\chapter}{0pt}{0pt}{20pt} % Отступы перед и после заголовка главы
...
\frenchspacing % Промежутки между словами и предложениями одинаковые
